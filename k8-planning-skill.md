...
- Preparing infrastructure planning before development begins
...
|---|---|
| Public access required | LoadBalancer + Ingress |
...
For each component:
- Define Service type — ClusterIP or LoadBalancer
- Assign correct ports
- Justify the choice

| Component | Service Type | Reason |
|---|---|---|
| Public component | ClusterIP + Ingress | Centralized external access |
...
### 14. Advanced Reliability — Optional Topper Level

Add these for high-traffic or AI-native applications:
...
- [ ] Audit and monitoring strategy included (High security)
